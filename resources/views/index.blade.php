        ...
        <header>
            ...
            <section id="intro">
                <article id="info" data-aos="fade-right" data-aos-delay="500">
                    ...
                    <p>Cria os teus enquetes de forma fácil e rápida, e compartilha com os seus colegas, amigos ou
                        colaboradores.</p>
                    @auth()
                ...
                <article id="banner">
                    <svg id="ef672dd0-2e16-4c9d-8107-606b55e40777" data-name="Layer 1"
                        ...
                        <circle cx="431.39281" cy="548" r="46" fill="#5e869b" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-177.66231 -152.36922)" fill="#5e869b" />
                        <path
